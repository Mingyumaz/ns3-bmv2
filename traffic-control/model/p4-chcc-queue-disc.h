...
#ifndef P4_CHCC_QUEUE_DISC_H
#define P4_CHCC_QUEUE_DISC_H
 ...
 *
 * The P4 Congestion Control for Haptic Communication(CHCC) qdisc is 
 * configured by a P4 program. It contains qdisc classes
 ...
 */
class P4ChccQueueDisc : public QueueDisc {
public:
  /**
  ...
  /**
   * \brief P4ChccQueueDisc constructor
   */
  P4ChccQueueDisc ();

  virtual ~P4ChccQueueDisc();
